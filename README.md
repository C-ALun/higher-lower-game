...
<div align="center">
  ...
  <p align="center">
    ...
    <br />
    <a href="https://github.com/C-ALun/higher-lower-game/blob/main/main.py">View My_demo</a>
  </p>
</div>
...
* I've learnt how to deal with data from another modules

* Fetched data and unpackaged it to use

* Understood can make a function to format data to remove duplicated code

* Better solve problem by break into small pieces
